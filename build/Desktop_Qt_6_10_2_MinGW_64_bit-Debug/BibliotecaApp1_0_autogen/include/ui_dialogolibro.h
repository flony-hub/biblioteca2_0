...
public:
    ...
    void setupUi(QDialog *DialogoLibro)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, labelBuscar);
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, labelTitulo);

        lineEditTitulo = new QLineEdit(groupBox);
        lineEditTitulo->setObjectName("lineEditTitulo");

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, lineEditTitulo);

        labelAutor = new QLabel(groupBox);
        labelAutor->setObjectName("labelAutor");

        formLayout->setWidget(2, QFormLayout::ItemRole::LabelRole, labelAutor);

        lineEditAutor = new QLineEdit(groupBox);
        lineEditAutor->setObjectName("lineEditAutor");

        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, lineEditAutor);

        labelEditorial = new QLabel(groupBox);
        labelEditorial->setObjectName("labelEditorial");

        formLayout->setWidget(3, QFormLayout::ItemRole::LabelRole, labelEditorial);

        lineEditEditorial = new QLineEdit(groupBox);
        lineEditEditorial->setObjectName("lineEditEditorial");

        formLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, lineEditEditorial);

        labelAnio = new QLabel(groupBox);
        labelAnio->setObjectName("labelAnio");

        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, labelAnio);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, spinBoxAnio);

        labelPais = new QLabel(groupBox);
        labelPais->setObjectName("labelPais");

        formLayout->setWidget(5, QFormLayout::ItemRole::LabelRole, labelPais);

        lineEditPais = new QLineEdit(groupBox);
        lineEditPais->setObjectName("lineEditPais");

        formLayout->setWidget(5, QFormLayout::ItemRole::FieldRole, lineEditPais);
