...
public:
    ...
    void setupUi(QDialog *DialogoPrestamo)
    {
        ...
        formLayout->setWidget(0, QFormLayout::LabelRole, labelISBN);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, lineEditDNI);

        labelFechaPrestamo = new QLabel(DialogoPrestamo);
        labelFechaPrestamo->setObjectName("labelFechaPrestamo");

        formLayout->setWidget(2, QFormLayout::LabelRole, labelFechaPrestamo);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, dateEditPrestamo);

        labelFechaDevolucion = new QLabel(DialogoPrestamo);
        labelFechaDevolucion->setObjectName("labelFechaDevolucion");

        formLayout->setWidget(3, QFormLayout::LabelRole, labelFechaDevolucion);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, dateEditDevolucion);
